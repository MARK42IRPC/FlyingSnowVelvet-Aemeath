...
飞行雪绒是面向 Windows 10/11 的桌面宠物项目。当前主线以 `LTS1.0.7pre1` 为版本基线，核心能力包括桌宠展示、事件驱动对象系统、AI 伴聊、语音播报、本地语音识别、多源音乐播放、粒子与小游戏扩展。
...
- 更新器从 ONNX 语音包的 Hugging Face / ModelScope 仓库下载并校验外层 ZIP 中的离线安装器 EXE；
