...
飞行雪绒是面向 Windows 10/11 的桌面宠物项目。当前主线以 `LTS1.0.6pre7v2` 为版本基线，核心能力包括桌宠展示、事件驱动对象系统、AI 伴聊、语音播报、本地语音识别、多源音乐播放、粒子与小游戏扩展。
...
- 控制面板工作台按页面懒加载，切换页面和主题使用淡入淡出；工作台可见期间临时将 FRAME 限制为 30 FPS，隐藏或销毁时恢复用户配置和其它模式的有效限制。
